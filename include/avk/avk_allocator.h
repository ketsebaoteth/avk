...
// Force VMA to compile in pure dynamic loading mode, integrating cleanly with Volk
...
namespace avk {
    ...
    public:
        ...
        AllocatedBuffer(VmaAllocator allocator, VkBuffer buffer, VmaAllocation allocation, const VmaAllocationInfo& allocInfo);
        ~AllocatedBuffer();
    ...
    public:
        ...
        AllocatedImage(VmaAllocator allocator, VkImage image, VmaAllocation allocation, VkExtent3D extent, VkFormat format);
        ~AllocatedImage();
    ...
    public:
        ...
        AllocatedBuffer createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VmaMemoryUsage memoryUsage, VmaAllocationCreateFlags flags = 0);
        AllocatedImage createImage(const VkImageCreateInfo& imageInfo, VmaMemoryUsage memoryUsage, VmaAllocationCreateFlags flags = 0);
